#### 基于JWT的SSO实现
![JWT_SSO_Scenerial](JWT_SSO_Scenerial.png)

##### 重写WhitelabelApprovalEndpoint

* 修改截图
![WhiteableApprovalEndpointRefractor](./WhiteableApprovalEndpointRefractor.png)
     ...
     * @author jiangy19
     * @version v1.0
     * @FileName SSOApprovalEndpoint
     * @date 2017/10/29 15:07
     */
    @RestController
